...
splom(s001small[,c("t_stage","tumor1edema","age","gender","weightloss","temperaturec","bpmmhg","pulsebpm","resp","karnovisky","lymphnode","cd4count","orf36","bmi","numberoflessions","age_cat","orf21","lytic","logcpskshv_","loghivrna")])

splom(s001small[,c("t_stage","tumor1edema","gender","karnovisky","lymphnode","cd4count","orf36","bmi","numberoflessions","orf21","lytic","lyticindex","logcpskshv_","loghivrna")])
