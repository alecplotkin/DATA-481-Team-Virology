...
heatmap.plus(try2m, na.rm = T, scale = "none", col = brewer.palette (55), hclustfun=function(m) hclust(m, method="ward"), distfun = function(x) dist(x, method = "manhattan"), margins = c(10,15), Colv = T, Rowv = T, main = "dCT", xlab = "CDS", ylab = "samples")
}
dev.off()
